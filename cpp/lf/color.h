...
enum COLORSPACE {
	RGB_SPACE, XYZ_SPACE, YIQ_SPACE, LAB_SPACE, LUV_SPACE
};
...
inline void RGBtoYIQ(double red, double green, double blue, double &luminance,
		double &I, double &Q) {
...
inline void YIQtoRGB(double luminance, double I, double Q, double & red,
...
void XYZtoRGB(PixType X, PixType Y, PixType Z, PixType &R, PixType &G,
		PixType &B) {
...
template<class PixType>
void RGBtoXYZ(PixType R, PixType G, PixType B, PixType &X, PixType &Y,
		PixType &Z) {
...
template<class PixType>
void XYZtoLuv(PixType X, PixType Y, PixType Z, PixType &L, PixType &u,
		PixType &v) {
	PixType Xn = 95.0456;
	PixType Yn = 100.0;
	PixType Zn = 108.8754;
...
template<class PixType>
void LuvtoXYZ(PixType L, PixType u, PixType v, PixType &X, PixType &Y,
		PixType &Z) {
	PixType Xn = 95.0456;
	PixType Yn = 100.0;
	PixType Zn = 108.8754;
...
template<class PixType>
void XYZtoLab(PixType X, PixType Y, PixType Z, PixType &L, PixType &a,
		PixType &b) {
	PixType Xn = 95.0456;
	PixType Yn = 100.0;
	PixType Zn = 108.8754;
...
template<class PixType>
void LabtoXYZ(PixType L, PixType a, PixType b, PixType &X, PixType &Y,
		PixType &Z) {
	PixType Xn = 95.0456;
	PixType Yn = 100.0;
	PixType Zn = 108.8754;
