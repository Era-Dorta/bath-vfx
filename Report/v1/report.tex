...
Our solution involves interpolating between the two offsets using variable factors, the idea is to have both eyes moving together, rapidly ignore if one eye goes off and while sustaining smooth movements.
