...
Wie et al.~\cite{Wei:2000} proposed a technique to synthesized new textures based on a sample image and a random noise.
...
% w3: with 68 shapes. Increase upper limit in solver to 1.2. NOthing changes.
