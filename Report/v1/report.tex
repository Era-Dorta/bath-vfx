...
\begin{algorithm}[htbp!] \label{alg:image_analogies}
	\caption{Image Analogies}
	\KwData{$A$ unfiltered example, $A'$ filtered example, $B$ unfiltered source, $L$ number of levels, $k$ coherence parameter, $k$ neighbourhood size.}
